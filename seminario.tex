...
son aplicados comenzando por el text based, anotaciones de keyword, basda en comapos(field based), 
basado en estrucutras, basado en contenido(CBIR), basado en sem\'antica hasta el basado en ontolog\'ia.
